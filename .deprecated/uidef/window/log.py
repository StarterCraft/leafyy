...
# Form implementation generated from reading ui file 'g:\Work\Code\leafyy\uisrc\window\log.ui'
#
...
"}")
        ...
        self.cbbSendMode.setMaximumSize(QtCore.QSize(90, 16777215))
        self.cbbSendMode.setObjectName("cbbSendMode")
        self.cbbSendMode.addItem("")
        self.cbbSendMode.addItem("")
        self.cbbSendMode.addItem("")
        self.cbbSendMode.addItem("")
    ...
    def retranslateUi(self, LogWindow):
        ...
        self.cbbSendMode.setItemText(0, _translate("LogWindow", "ASCII"))
        self.cbbSendMode.setItemText(1, _translate("LogWindow", "BIN"))
        self.cbbSendMode.setItemText(2, _translate("LogWindow", "OCT"))
        self.cbbSendMode.setItemText(3, _translate("LogWindow", "HEX"))
        ...
        self.meiViewSettings.setText(_translate("LogWindow", "Внешний вид..."))
